...
const listFaq = [
    ...
    {question:"Apakah ada biaya pendaftaran?",answer:"Ya. Untuk rincian biaya pendaftaran Collegacy Business Case Competition sebagai berikut: [enter]Pendaftaran early bird: Rp 50.000 [enter]Pendaftaran normal wave: Rp 65.000 [enter]Pendaftaran late registration: Rp 75.000 [enter]Pendaftaran internasional: Rp 85.000"},
    ...
    {question:"Apa saja syarat dan ketentuan pendaftaran CBCC?",answer:"- Peserta lomba merupakan Warga Negara Indonesia dan masih berstatus sebagai mahasiswa aktif tahap sarjana (S1), diploma, atau sederajat. [enter] - Peserta lomba maksimal berusia 23 tahun per tanggal 1 Maret 2021.[enter] - Peserta dapat berasal dari universitas manapun (dalam dan luar negeri).[enter] - Peserta mendaftar secara individu.[enter] - Setiap perguruan tinggi berhak mengajukan lebih dari satu peserta."},
    {question:"Bagaimana langkah-langkah pendaftaran CBCC?",answer:"1) Melengkapi formulir pendaftaran[enter] 2) Melampirkan KTM (Kartu Tanda Mahasiswa)[enter]3) Melampirkan bukti telah mem-follow akun @sejutacita.id, @collegacy.bcc,dan [enter] @collegacybandung di Instagram[enter] 4) Melampirkan screenshot bukti telah mem-posting twibbon[enter] 5) Melampirkan hasil test MBTI dari situs https://www.16personalities.com/ dan hasil karakter dominan tes DISC Personality dari situs https://www.123test.com/disc-personality-test[enter] 6) Mentransfer biaya pendaftaran ke[enter] 7) Melampirkan bukti transfer biaya pendaftaran"},]
