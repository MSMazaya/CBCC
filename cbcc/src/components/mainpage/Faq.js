...
const listFaq = [
    ...
    {question:"Bagaimana langkah-langkah pendaftaran CBCC?",answer:"1) Melengkapi formulir pendaftaran[enter] 2) Melampirkan KTM (Kartu Tanda Mahasiswa)[enter] 3) Melampirkan bukti telah mem-follow akun @sejutacita.id, @collegacy.bcc, dan @collegacybandung di Instagram[enter] 4) Melampirkan screenshot bukti telah mem-posting twibbon[enter] 5) Melampirkan hasil test MBTI dari situs https://www.16personalities.com/ dan hasil karakter dominan tes DISC Personality dari situs https://www.123test.com/disc-personality-test[enter] 6) Mentransfer biaya pendaftaran ke[enter] 7) Melampirkan bukti transfer biaya pendaftaran"},]
